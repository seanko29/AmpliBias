...
if __name__=='__main__':
    ...
    parser.add_argument("--root", type=str, default="/home/work/Data/data/debias/bar", help="Dataset root")
    parser.add_argument("--save_root", type=str, default="/home/work/Data/debiasing/augbias/bar_result", help="where the model was saved")

    parser.add_argument("--exp", type=str, default='bar', help="Dataset name")     # new-cmnist/bffhq/bar/bar
    parser.add_argument("--data_type", type=str, default='bar', help='kind of data used')
    parser.add_argument("--pct", type=str, default="5pct", help="Percent name")
    parser.add_argument("--etc", type=str, default='vanila', help="Experiment name")
    ...
    ### BUILD DATASET
    train_align    = [y for x in os.walk(f"/home/work/Data/data/debias/bar/{args.pct}/align/") for y in glob(os.path.join(x[0], '*/*.png'))]
    train_conflict = [y for x in os.walk(f'/home/work/Data/data/debias/bar/{args.pct}/conflict/') for y in glob(os.path.join(x[0], '*/*.png'))]

    train_data = train_align + train_conflict
 
    valid_data = [y for x in os.walk(f'/home/work/Data/data/debias/bar/valid') for y in glob(os.path.join(x[0], '*.png'))]
    test_data  = [y for x in os.walk(f'/home/work/Data/data/debias/bar/test') for y in glob(os.path.join(x[0], '*.png'))]
